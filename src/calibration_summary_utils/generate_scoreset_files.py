...
def generate_scoreset_files(
    pillar_df_filepath, scoreset_save_dir, scoreset_summary_dir=None
):
    """
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Generate scoreset JSON files and summaries."
    )
    parser.add_argument(
        "pillar_df_filepath", type=str, help="Path to the pillar dataframe file."
    )
    parser.add_argument(
        "scoreset_save_dir", type=str, help="Directory to save the scoreset JSON files."
    )
    parser.add_argument(
        "--scoreset_summary_dir",
        type=str,
        default=None,
    ...
    generate_scoreset_files(
        args.pillar_df_filepath, args.scoreset_save_dir, args.scoreset_summary_dir
    )
