...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Plot prior distributions from a summary JSON file.")
    parser.add_argument("prior_summary_filepath", type=Path, help="Filepath to the JSON file containing prior summaries.")
    parser.add_argument("figure_filepath", type=Path, help="Filepath to save the figure of prior distributions.")
