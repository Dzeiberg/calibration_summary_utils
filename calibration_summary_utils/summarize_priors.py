...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Summarize prior distributions from JSON files.")
    parser.add_argument("summaries_dir", type=Path, help="Directory containing JSON files with prior distributions.")
    parser.add_argument("--write_filepath", type=Path, default=None, help="Filepath to write the summary JSON file.")
